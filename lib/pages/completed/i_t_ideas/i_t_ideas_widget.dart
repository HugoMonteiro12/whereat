                                ...
                                Expanded(
                                  child: Autocomplete<String>(
                                    ...
                                    optionsBuilder: (textEditingValue) {
                                      ...
                                      return iTIdeasItinerariesRecordList
                                          .map((e) => e.city)
                                          .toList()
                                          .where((option) {
                                ...
                                return InkWell(
                                  ...
                                  child: Card(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Hero(
                                          tag: itinerariesItem.image,
                                          transitionOnUserGestures: true,
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(0.0),
                                            child: Image.network(
                                              itinerariesItem.image,
                                              width: double.infinity,
                                              height: 200.0,
                                              fit: BoxFit.fitWidth,
                                            ),
