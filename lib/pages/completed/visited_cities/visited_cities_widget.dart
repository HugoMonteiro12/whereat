...
class VisitedCitiesWidget extends StatefulWidget {
...
class _VisitedCitiesWidgetState extends State<VisitedCitiesWidget> {
  late VisitedCitiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisitedCitiesModel());
  }
                      ...
                      return MasonryGridView.builder(
                        ...
                        itemBuilder: (context, staggeredViewIndex) {
                          final staggeredViewCitiesRecord =
                              staggeredViewCitiesRecordList[staggeredViewIndex];
                          return Builder(
